...
# Команда /start
        ...
        await bot.send_photo(
                chat_id=chat_id,
                photo="https://polyana-hotel.ru/wp-content/uploads/2024/07/dsc05048-scaled.jpg",  # Замени на URL картинки
        ...
        # Команда /help
            ...
            await bot.send_message(
                chat_id=chat_id,
                text='Я помогу с информацией об отеле "Поляна":\n'
                     '- Номера и цены\n'
                     '- Услуги (баня, бассейн, массаж)\n'
    ...
    # Обработка inline-кнопок
        ...
        if callback_data == "contact":
            ...
            await bot.send_message(
                chat_id=chat_id,
                text='📞 Контакты Парк-отеля "Поляна"\n\n'
